...
[LTSample for Android](https://github.com/LoFTechs/LTSample-Android-Java.git) 1.0.0 or higher.
...
- You can **clone** the project from the [LTSample repository](https://github.com/LoFTechs/LTSample-Android-Java.git).
